    ...
    def __init__(
        ...
        Args:
            ...
            hub_repo_name (str): The name of the Hugging Face repository to push
                ...
                `language-eval-results`. Deprecated in favor of details_repo_name and
                results_repo_name.
            details_repo_name (str): The name of the Hugging Face repository to push
                the details to. If not provided, defaults to `language-eval-results`.
        ...
        if hub_repo_name == "":
            details_repo_name = (
                details_repo_name if details_repo_name != "" else "language-eval-results"
            )
            results_repo_name = (
