...
def add_env_info(storage: dict[str, Any]):
    from language_eval.utils import is_torch_available, is_transformers_available
    ...
    try:
        language_eval_version = version("language_eval")
    except Exception as err:
        language_eval_version = str(err)
    ...
    added_info = {
        ...
        "language_eval_version": language_eval_version,
