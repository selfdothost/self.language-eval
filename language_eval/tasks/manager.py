...
from language_eval.tasks._factory import TaskFactory
from language_eval.tasks._index import Entry, Kind, TaskIndex
from language_eval.tasks._yaml_loader import load_yaml
...
class TaskManager:
    ...
    def __init__(
        ...
        Args:
            ...
            include_defaults: Whether to include built-in tasks from language_eval/tasks/
    ...
    def load_task_or_group(self, task_list: str | list[str | dict]) -> dict:
        ...
        from language_eval.api.group import ConfigurableGroup
    ...
    def list_all_tasks(
        ...
        def sanitize_path(path):
            if path is None:
                return "---"
            path_str = str(path)
            if "language_eval/tasks/" in path_str:
                return "language_eval/tasks/" + path_str.split("language_eval/tasks/")[-1]
            return path_str
