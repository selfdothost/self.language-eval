...
# Import TaskManager
from language_eval.tasks.manager import TaskManager
...
def _log_task_dict(task_dict: dict, task_manager: "TaskManager") -> None:
    ...
    def pretty_print_task(task_name: str, indent: int):
        ...
        if entry and entry.yaml_path:
            ...
            language_eval_tasks_path = Path(__file__).parent
            try:
                display_path = yaml_path.relative_to(language_eval_tasks_path)
            except ValueError:
...
def get_task_dict(
    ...
    :param task_name_list: List[Union[str, Dict, Task]]
        Name of model or LM object, see language_eval.models.get_model
