...
class List(SubCommand):
    ...
    def __init__(self, subparsers: argparse._SubParsersAction, *args, **kwargs):
        ...
        self._parser = subparsers.add_parser(
            ...
            usage="language-eval list [tasks|groups|subtasks|tags] [--include_path DIR]",
            epilog=textwrap.dedent("""
                examples:
                  ...
                  $ language-eval ls tasks --include_path "/path/to/tasks1:/path/to/tasks2"
