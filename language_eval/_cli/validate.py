...
class Validate(SubCommand):
    ...
    def __init__(self, subparsers: argparse._SubParsersAction, *args, **kwargs):
        ...
        self._parser = subparsers.add_parser(
            ...
            usage="language-eval validate --tasks <task1,task2> [--include_path DIR]",
            epilog=textwrap.dedent("""
                examples:
                  ...
                  language-eval validate --tasks custom_task1,custom_task2 --include_path "/path/to/tasks1:/path/to/tasks2"
                ...
                debugging tips:
                  ...
                  • Use 'language-eval list tasks' to see available tasks
