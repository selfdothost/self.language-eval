...
from language_eval._cli.subcommand import SubCommand
from language_eval._cli.utils import (
    MergeDictAction,
    SplitArgs,
...
class Run(SubCommand):
    ...
    def __init__(self, subparsers: argparse._SubParsersAction, *args, **kwargs):
        ...
        self._parser = subparsers.add_parser(
            ...
            usage="language-eval run --model <model> --tasks <task> <task> --model_args <arg=value> <arg=value> [options]",
            epilog=textwrap.dedent("""
                examples:
                  ...
                  $ language-eval run --model hf --model_args pretrained=gpt2 --tasks lambada --gen_kwargs temperature=0.8 top_p=0.95 'stop=["\\n\\n"]'
    ...
    def _add_args(self) -> None:
        ...
        model_group.add_argument(
            ...
            help=textwrap.dedent("""
                ...
                Use 'language-eval list tasks' to see all available tasks.
            """).strip(),
        )
        model_group.add_argument(
            "--model",
    ...
    def _execute(args: argparse.Namespace) -> None:
        ...
        from language_eval.config.evaluate_config import EvaluatorConfig
        ...
        from language_eval import simple_evaluate
        from language_eval.loggers import EvaluationTracker, WandbLogger
        from language_eval.utils import handle_non_serializable, make_table
