...
from language_eval.models.utils import Collator, chunks, configure_pad_token
        ...
        **kwargs,
        ...
        if missing_packages:
            raise ModuleNotFoundError(
                ...
                'Please install these via `pip install language-eval[api]` or `pip install -e ."[api]"`'
            )
                ...
                if self.tokenizer_backend == "huggingface":
                    ...
                    try:
                        ...
                        raise ModuleNotFoundError(
                            ...
                            "Please install it via `pip install language-eval[api]` or `pip install -e .[api]`."
                        ) from e
                    ...
                    from language_eval.utils import RemoteTokenizer
