...
from language_eval.models.api_models import JsonChatStr
from language_eval.utils import simple_parse_args_string
...
def get_watsonx_credentials() -> dict[str, str | None]:
    ...
    try:
        ...
        raise ImportError(
            "Could not import dotenv: Please install language_eval[ibm_watsonx_ai] package."
        ) from None
...
class WatsonxLLM(LM):
    """
    Implementation of LM model interface for evaluating Watsonx model with the language_eval framework.
    ...
    def create_from_arg_string(
        ...
        try:
            ...
            raise ImportError(
                "Could not import ibm_watsonx_ai: Please install language_eval[ibm_watsonx_ai] package."
            ) from None
