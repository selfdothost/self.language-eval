...
class SGLangLM(TemplateLM):
    ...
    def __init__(
        self,
        pretrained: str,
        # batch args from language-eval interface:  https://github.com/EleutherAI/lm-evaluation-harness/blob/main/docs/interface.md
    ...
    def chat_template(self, chat_template: Union[bool, str] = False) -> str:
        ...
        For the reference implementation, see HFLM class in `language_eval.models.huggingface`.
