...
from language_eval.models.utils import (
    Collator,
    _add_special_kwargs,
    configure_pad_token,
...
from language_eval.models.utils_hf import (
    clear_torch_cache,
    get_dtype,
    pad_and_concat,
            ...
            if autogptq:
                try:
                    ...
                    raise type(exception)(
                        ...
                        "please install auto-gptq via pip install language-eval[gptq] or pip install -e .[gptq]",
                    ) from exception
            ...
            if gptqmodel:
                try:
                    ...
                    raise type(exception)(
                        ...
                        "please install gptqmodel via `pip install gptqmodel --no-build-isolation` or `pip install language-eval[gptqmodel] --no-build-isolation`",
                    ) from exception
