...
import language_eval.models.utils
import language_eval.models.utils_hf
from language_eval import utils
from language_eval.api.model import TemplateLM
from language_eval.api.registry import register_model
from language_eval.models.utils_hf import stop_sequences_criteria
...
class NEURON_HF(TemplateLM):
    ...
    def __init__(
        ...
        if neuron_config is None:
            ...
            torch_dtype = language_eval.models.utils_hf.get_dtype(dtype)
    ...
    def _loglikelihood_tokens(
        ...
        chunks = language_eval.models.utils.chunks(
        ...
        for chunk in tqdm(chunks, disable=(disable_tqdm or (self.rank != 0))):
            ...
            batched_inps = language_eval.models.utils_hf.pad_and_concat(
                padding_len_inp, inps, padding_side="right"
            )  # [batch, padding_len_inp]

            batched_masks = language_eval.models.utils_hf.pad_and_concat(
    ...
    def generate_until(self, requests, disable_tqdm: bool = False):
        ...
        # in the same batch.
        grouper = language_eval.models.utils.Grouper(requests, lambda x: str(x.args[1]))
