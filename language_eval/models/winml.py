"""
WinML backend for language-eval-harness with NPU/GPU/CPU support.
...
Example usage:
    language_eval --model winml --model_args pretrained=path/to/onnx/model.onnx --tasks hellaswag
...
class WindowsML(TemplateLM):
    """
    WindowsML backend for language-eval-harness with NPU/GPU/CPU support.
