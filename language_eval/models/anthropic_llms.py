...
from language_eval.models.utils import handle_stop_sequences, retry_on_specific_exceptions
...
please install anthropic via `pip install 'language-eval[anthropic]'` or `pip install -e '.[anthropic]'`",
        )
