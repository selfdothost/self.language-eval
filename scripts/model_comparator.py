...
if __name__ == "__main__":
    ...
    results_vllm = language_eval.evaluator.simple_evaluate(
        model="vllm",
    ...
    memory_stats()
    language_eval.models.utils_hf.clear_torch_cache()
    eval_logger.info("Memory stats cleared")
    memory_stats()
    results_hf = language_eval.evaluator.simple_evaluate(
        model="hf",
