...
# from language_eval.api.registry import ALL_TASKS
eval_logger = logging.getLogger(__name__)


# from language_eval.tasks import include_task_folder
...
def parse_args():
    ...
    parser.add_argument("--task_save_path", default="language_eval/tasks/")
