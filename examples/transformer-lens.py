...
def evaluate_language_eval(lens_model: HookedTransformer, tasks: list[str], **kwargs):
    class HFLikeModelAdapter(nn.Module):
        """Adapts HookedTransformer to match the HuggingFace interface expected by language-eval"""
...
if __name__ == "__main__":
    ...
    res = evaluate_language_eval(model, tasks=["arc_easy"])
    print(res["results"])
