...
from language_eval.models.gguf import GGUFLM
...
class GGUFLMTest(unittest.TestCase):
    @patch(
        "language_eval.models.gguf.GGUFLM.gguf_completion", side_effect=gguf_completion_mock
    )
    ...
    # @patch('language_eval.models.gguf.GGUFLM.gguf_completion', side_effect=gguf_completion_mock)
