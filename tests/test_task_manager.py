...
def task_yaml(pytestconfig, custom_task_name, custom_task_tag):
    yield f"""include: {pytestconfig.rootpath}/language_eval/tasks/arc/arc_easy.yaml
...
def task_code():
    return """
from language_eval.api.task import ConfigurableTask
...
class TestGroupBuilding:
    ...
    def test_parse_aggregation_with_list(self):
        ...
        from language_eval.config.group import AggMetricConfig, GroupConfig
    ...
    def test_parse_aggregation_missing_returns_none(self):
        ...
        from language_eval.config.group import GroupConfig
